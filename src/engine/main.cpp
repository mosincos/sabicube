...
//	if(loadinv[0] == 1) f->printf("exec packages/base/escape/inventory.cfg\n");
	if(loadinv[0] == 0) f->printf("//exec packages/base/zetaproject/escape/inventory.cfg\n");
	if(loadinv[0] == 1) f->printf("exec packages/base/zetaproject/escape/inventory.cfg\n");
	if(loadtri[0] == 0) f->printf("//exec packages/base/zetaproject/escape/triggers.cfg\n");
	if(loadtri[0] == 1) f->printf("exec packages/base/zetaproject/escape/triggers.cfg\n");
	...
	f->printf("// exec packages/textures/blikjebier/snow/package.cfg\n");
	f->printf("// exec packages/textures/dg/package.cfg\n");
	f->printf("// exec packages/textures/gor/package.cfg\n");
	f->printf("// exec packages/textures/ik2k/package.cfg\n");
	f->printf("// exec packages/textures/ikbase/package.cfg\n");
	f->printf("// exec packages/textures/jf1/package.cfg\n");
	f->printf("// exec packages/textures/luckystrike/package.cfg\n");
	f->printf("// exec packages/textures/lunaran/package.cfg\n");
	...
	f->printf("// exec packages/textures/submerged/package.cfg\n");
	f->printf("// exec packages/textures/tech1soc/package.cfg\n");
	f->printf("// exec packages/textures/trak/trak2/package.cfg\n");
	f->printf("// exec packages/textures/trak/trak4/package.cfg\n");
	f->printf("// exec packages/textures/trak/trak5/package.cfg\n");
	f->printf("// exec packages/textures/trak/trak6/package.cfg\n");
